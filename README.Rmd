...
fm <- GFR(data, nIter = 1000, burnIn = 300, verbose = F)
...
pm <- GFR(data, nIter = 1000, burnIn = 300, set_seed = 10, CrossValidation = Crossvalidation_list, verbose = F)
summary(pm)
...
pm2 <- GFR(ETA = ETA2, data, nIter = 1000, burnIn = 300, set_seed = 10, CrossValidation = CrossV, verbose = F)
summary(pm2)
...
ETA3$Prior
ETA3$Method
pm3 <- GFR(ETA = ETA3, data, nIter = 1000, burnIn = 300, set_seed = 10, CrossValidation = CrossV, verbose = F)
summary(pm3)
```
...
pm4 <- GFR(data = Wheat_GFR, ETA = ETA4, nIter = 1000, burnIn = 300, CrossValidation = CrossV, set_seed = 10, verbose = F)
summary(pm4)
...
[downloads-badge]: http://cranlogs.r-pkg.org/badges/GFR "IBCF.MTME cranlogs"
[release-badge]: http://www.r-pkg.org/badges/version-ago/GFR "IBCF.MTME release"
