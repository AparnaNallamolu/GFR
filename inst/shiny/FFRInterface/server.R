...
function(input, output, session) {
  ...
  design <- list('Frequentist-Single' = '$$\\eta = NULL$$',
                 'Frequentist-SingleBands' = '$$\\eta = Bands$$',
                 'Frequentist-Env' = '$$\\eta = Env + Line + Env \\times Line$$',
                 'Frequentist-EnvBands' = '$$\\eta = Env + Line + Env \\times Line + Bands$$',
                 'Frequentist-Trait' = '$$\\eta = Trait + Line + Trait \\times Line$$',
                 'Frequentist-TraitBands' = '$$\\eta = Trait + Line + Trait \\times Line + Bands$$',
                 'Frequentist-Multi' = '$$\\eta = Env + Trait + Line + Line \\times Env + Line \\times Trait + Env\\times Line\\times Trait $$',
                 'Frequentist-MultiBands' = '$$\\eta = Env + Trait + Line + Line \\times Env + Line \\times Trait + Env\\times Line\\times Trait + Bands$$')
