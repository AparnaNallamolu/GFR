...
fluidPage(
  # App title ----
  titlePanel("Frequentist Functional Regression"),
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      # Select the LineID
      selectInput('REML', 'Response Type:', c(TRUE, FALSE), multiple = FALSE, selectize = FALSE),

      # Select numbers
      numericInput("iter", "Iterations:", min = 1, max = 1000, value = 20, step = 1),
